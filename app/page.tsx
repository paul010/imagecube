...
const tools = [
  { 
    name: '随机电话号码生成', 
    icon: '/images/phone-generator.svg', 
    href: '/phone-generator',
    description: '生成随机的测试电话号码，支持多个国家和地区的号码格式。'
  },
  { 
    name: 'AI 文生图', 
  ...
  { 
    ...
    href: '/ppt-generator',
    description: '将SVG图形转换为PPT格式，方便在演示文稿中使用。'
  },
  { 
    name: '极简Logo设计', 
  ...
  { 
    name: 'Text Behind Object', 
    icon: '/images/text-behind-object.svg', 
    href: '/text-behind-object',
    description: '创建文字环绕效果，让文本自然地融入图像背景中。'
  }
];
