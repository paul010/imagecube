...
const sidebarAds = [
  ...
  {
    title: 'ChatGPT会员合租',
    description: '国内镜像直连，快速获取ChatGPT Plus会员',
    link: 'https://nf.video/f5YfJ/?gid=18',
    tag: '29元/月',
    socialProof: '已有10万+人购买'
  },
  {
    title: 'Midjourney会员购买',
    description: '真实感拉满，AI绘图top1',
    link: 'https://nf.video/f5YfJ/?gid=26',
    tag: '29元/月',
    socialProof: '1000万+月付费用户'
  },
  {
    title: 'Claude会员购买',
    description: '无需翻墙，国内直连',
    link: 'https://nf.video/f5YfJ/?gid=75',
    tag: '写作能力超ChatGPT',
    socialProof: '8元单日体验卡'
  }
];
      ...
      <List>
        {menuItems.map((item) => (
          ...
          >
            ...
            >
              <a style={{ display: 'flex', width: '100%', alignItems: 'center' }}>
                <ListItemIcon sx={{ 
                  minWidth: 40,
                  display: 'flex',
                  alignItems: 'center',
          ...
          <Toolbar>
            ...
            <Link href="/" passHref legacyBehavior>
              <a style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', color: 'inherit' }}>
                ...
                >
                 Random Numbers, Endless Imagery
                </Typography>
              </a>
            </Link>
            <Box sx={{ flexGrow: 1 }} />
